...
// const { PrismaClient: PrismaClientApp } = require('@prisma/client/app');
// const { PrismaClient: PrismaClientCollection } = require('@prisma/client/collection');

import { PrismaClient as PrismaClientCollection } from './generated/collection';
const prisma = new PrismaClientCollection();
